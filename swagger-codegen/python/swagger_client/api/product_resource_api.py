...
class ProductResourceApi(object):
    ...
    def create_product(self, body, **kwargs):  # noqa: E501
        ...
        :param ProductDTO body: (required)
        :return: ProductDTO
    ...
    def partial_update_product(self, body, id, **kwargs):  # noqa: E501
        """partial_update_product  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.partial_update_product(body, id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.partial_update_product_with_http_info(body, id, **kwargs)  # noqa: E501
        else:
            (data) = self.partial_update_product_with_http_info(body, id, **kwargs)  # noqa: E501
            return data

    def partial_update_product_with_http_info(self, body, id, **kwargs):  # noqa: E501
        """partial_update_product  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.partial_update_product_with_http_info(body, id, async_req=True)
        >>> result = thread.get()
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `partial_update_product`")  # noqa: E501
        # verify the required parameter 'id' is set
        if ('id' not in params or
                params['id'] is None):
