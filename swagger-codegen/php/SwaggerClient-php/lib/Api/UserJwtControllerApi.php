...
class UserJwtControllerApi
{
     ...
     * Operation authorize
     *
     * @param  \Swagger\Client\Model\LoginVM $body body (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\JWTToken
     */
     ...
     *
     * @param  \Swagger\Client\Model\LoginVM $body (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\JWTToken, HTTP status code, HTTP response headers (array of strings)
     */
    public function authorizeWithHttpInfo($body)
    {
        $returnType = '\Swagger\Client\Model\JWTToken';
