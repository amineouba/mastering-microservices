...
import static mosig.cloud.store.web.rest.TestUtil.sameNumber;
...
import mosig.cloud.store.domain.enumeration.ProductSize;
import mosig.cloud.store.repository.ProductRepository;
import mosig.cloud.store.service.ProductService;
import mosig.cloud.store.service.dto.ProductDTO;
import mosig.cloud.store.service.mapper.ProductMapper;
...
class ProductResourceIT {
    ...
    @Test
    @Transactional
    void checkEanIsRequired() throws Exception {
        int databaseSizeBeforeTest = productRepository.findAll().size();
        // set the field null
        product.setEan(null);
