...
class CustomerDetailsResourceIT {
    ...
    private static final String DEFAULT_GEOHASH = "AAAAAAAAAA";
    private static final String UPDATED_GEOHASH = "BBBBBBBBBB";

    private static final String DEFAULT_OLC = "AAAAAAAAAA";
    private static final String UPDATED_OLC = "BBBBBBBBBB";
    ...
    void createCustomerDetails() throws Exception {
        ...
        assertThat(testCustomerDetails.getLatitude()).isEqualTo(DEFAULT_LATITUDE);
        assertThat(testCustomerDetails.getLongitude()).isEqualTo(DEFAULT_LONGITUDE);
        assertThat(testCustomerDetails.getGeohash()).isEqualTo(DEFAULT_GEOHASH);
        assertThat(testCustomerDetails.getOlc()).isEqualTo(DEFAULT_OLC);
    }
    ...
    void getAllCustomerDetails() throws Exception {
        ...
        restCustomerDetailsMockMvc
            ...
            .andExpect(jsonPath("$.[*].geohash").value(hasItem(DEFAULT_GEOHASH)))
            .andExpect(jsonPath("$.[*].olc").value(hasItem(DEFAULT_OLC)));
    }
    ...
    void getCustomerDetails() throws Exception {
        ...
        restCustomerDetailsMockMvc
            ...
            .andExpect(jsonPath("$.geohash").value(DEFAULT_GEOHASH))
            .andExpect(jsonPath("$.olc").value(DEFAULT_OLC));
    }
    ...
    void putExistingCustomerDetails() throws Exception {
        ...
        assertThat(testCustomerDetails.getLatitude()).isEqualTo(UPDATED_LATITUDE);
        assertThat(testCustomerDetails.getLongitude()).isEqualTo(UPDATED_LONGITUDE);
        assertThat(testCustomerDetails.getGeohash()).isEqualTo(UPDATED_GEOHASH);
        assertThat(testCustomerDetails.getOlc()).isEqualTo(UPDATED_OLC);
    }
