...
type CustomerDetailsFormGroupContent = {
  ...
  latitude: FormControl<ICustomerDetails['latitude']>;
  longitude: FormControl<ICustomerDetails['longitude']>;
  geohash: FormControl<ICustomerDetails['geohash']>;
  olc: FormControl<ICustomerDetails['olc']>;
...
export class CustomerDetailsFormService {
  createCustomerDetailsFormGroup(customerDetails: CustomerDetailsFormGroupInput = { id: null }): CustomerDetailsFormGroup {
    ...
    return new FormGroup<CustomerDetailsFormGroupContent>({
      ...
      latitude: new FormControl(customerDetailsRawValue.latitude),
      longitude: new FormControl(customerDetailsRawValue.longitude),
      geohash: new FormControl(customerDetailsRawValue.geohash),
      olc: new FormControl(customerDetailsRawValue.olc),
