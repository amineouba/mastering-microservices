package mosig.cloud.store.gateway.web.rest;
...
import mosig.cloud.store.gateway.repository.UserRepository;
import mosig.cloud.store.gateway.security.AuthoritiesConstants;
import mosig.cloud.store.gateway.service.MailService;
import mosig.cloud.store.gateway.service.UserService;
import mosig.cloud.store.gateway.service.dto.AdminUserDTO;
import mosig.cloud.store.gateway.web.rest.errors.BadRequestAlertException;
import mosig.cloud.store.gateway.web.rest.errors.EmailAlreadyUsedException;
import mosig.cloud.store.gateway.web.rest.errors.LoginAlreadyUsedException;
 ...
 * <p>
 * This class accesses the {@link mosig.cloud.store.gateway.domain.User} entity, and needs to fetch its collection of authorities.
 * <p>
