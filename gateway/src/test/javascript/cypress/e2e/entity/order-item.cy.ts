        ...
        cy.authenticatedRequest({
          ...
          cy.intercept(
            ...
            },
            {
              statusCode: 200,
              headers: {
                link: '<http://localhost/services/productorder/api/order-items?page=0&size=20>; rel="last",<http://localhost/services/productorder/api/order-items?page=0&size=20>; rel="first"',
              },
              body: [orderItem],
            }
