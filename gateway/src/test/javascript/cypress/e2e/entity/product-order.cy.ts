...
describe('ProductOrder e2e test', () => {
  ...
  const productOrderSample = { placedDate: '2023-01-25T21:54:12.294Z', status: 'CANCELLED', code: 'Buckinghamshire' };
  ...
  describe('new ProductOrder page', () => {
    ...
    it('should create an instance of ProductOrder', () => {
      cy.get(`[data-cy="placedDate"]`).type('2023-01-25T16:06').blur().should('have.value', '2023-01-25T16:06');
