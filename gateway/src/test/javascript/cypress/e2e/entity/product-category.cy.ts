...
describe('ProductCategory e2e test', () => {
  ...
  const productCategorySample = { name: 'Lorraine Picardie Chair' };
        ...
        cy.authenticatedRequest({
          ...
          cy.intercept(
            ...
            },
            {
              statusCode: 200,
              headers: {
                link: '<http://localhost/services/productorder/api/product-categories?page=0&size=20>; rel="last",<http://localhost/services/productorder/api/product-categories?page=0&size=20>; rel="first"',
              },
