...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("mosig.cloud.store.gateway.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("mosig.cloud.store.gateway.security.DomainUserDetailsService", "createSpringSecurityUser");
    }
}
